        ...
        <div className="flex flex-col gap-1">
          ...
          {selectedAssetTypes.size > 0 && (
            <span className="text-xs text-blue-600">
              {[...selectedAssetTypes].map((t) => ASSET_TYPE_LABELS[t as AssetType]).join(", ")}
              <button onClick={() => { setSelectedAssetTypes(new Set()); setSelectedSymbols(new Set()); }} className="ml-1 text-gray-400 hover:text-gray-600">✕</button>
            </span>
          )}
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          {selectedSymbols.size > 0 && (
            <span className="text-xs text-blue-600">
              ...
              <button onClick={() => setSelectedSymbols(new Set())} className="ml-1 text-gray-400 hover:text-gray-600">✕</button>
            </span>
          )}
        </div>
